...
<head>
  ...
  <title>Sistema Repuestos |Mantenimiento Proveedor</title>
  ...
  <div class="content-wrapper">
   <section class="content-header">
      <div class="container-fluid">
          ...
          <div class="col-sm-6">
            <ol class="breadcrumb float-sm-right">
              ...
              <li class="breadcrumb-item" style="color:#0056b3;">Mantenimientos</li>
                <li class="breadcrumb-item" style="color:#3d3d3d"><b>Mantenimiento Proveedores</b></li>
            </ol>
          </div>
        </div>
      </div>
        ...
        $consulta = "SELECT Id_Proveedor as Id FROM tbl_proveedor ORDER by Id_Proveedor DESC LIMIT 1";
    ...
    <section class="content">
         <form action="Mantenimientos/Capas/Logica/Log.php" method="post" id="mantenProvee" name="mantenProvee">
             <input hidden type="text"  id="proveedor" name="proveedor" value="Proveedor">
      <div class="container-fluid">
        <div class="card card-default">
         ...
         <div class="col-md-6">
                <div class="form-group">
                  <center><label for="exampleInputEmail1" style="margin-left: -41px;font-size: 20px;">Codigo Proveedor</label></center>
              ...
              <div class="col-md-6">
                ...
                <div class="form-group">
                 ...
                 <div class="col-md-4">
                      <br>
                     <center><button type="submit" form="mantenProvee" style="background-color:#3c3c3c" class="btn btn-block btn-success">Guardar</button></center> 
                  </div>
            </div>
          </div>
        </div> 
