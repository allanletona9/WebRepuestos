...
namespace App\SistemaRepuestos\pages\forms\Mantenimientos\Capas\Datos\Datos;
...
//Mantenimiento Clientes         
    public function Clientes($Nombre,$Nit,$Direccion)
    {
        self::setNames();
        $inf = 0;
...
public function Proveedores($Nombre,$Nit,$Direccion)
    {
        self::setNames();
        $inf = 0;
 ...
 public function TipoPago($Nombre)
    {
        self::setNames();
        $inf = 0;
...
public function TipoRepuesto($Nombre)
    {
        self::setNames();
        $inf = 0;
 ...
 // ----------------------------------------------------------------------------------------------------------------------------------
   //Mantenimiento Tipo de Repuesto     
   public function Usuario($Nombre,$Apellido,$Pass)
    {
        self::setNames();
        $inf = 0;
        ...
        {
           $encrypt=sha1($Pass);
           $sql = "INSERT INTO tbl_usuarios (`Id_Usuario`, `Nombre_Usuario`, `Apellido_Usuario`, `Pasword_Usuario`, `Estado`) VALUES (NULL, '$Nombre', '$Apellido', '$encrypt', '1');";
           $result = $this->db->query($sql);
