...
<head>
  ...
  <title>Sistema Repuestos |Mantenimiento Tipo de Pago</title>
  ...
  <div class="content-wrapper">
   <section class="content-header">
      <div class="container-fluid">
        <div class="row mb-2">
          <div class="col-sm-6">
            <h1>Mantenimiento de Tipo Pago</h1>
          </div>
          <div class="col-sm-6">
            <ol class="breadcrumb float-sm-right">
              ...
              <li class="breadcrumb-item" style="color:#0056b3;">Mantenimientos</li>
                <li class="breadcrumb-item" style="color:#3d3d3d"><b>Mantenimiento Tipo Pago</b></li>
            </ol>
          </div>
        </div>
      </div>
        ...
        $consulta = "SELECT Id_TipoPago as Id FROM tbl_tipo_pago ORDER by Id_TipoPago DESC LIMIT 1";
    ...
    <section class="content">
         <form action="Mantenimientos/Capas/Logica/Log.php" method="post" id="mantenTPago" name="mantenTPago">
             <input hidden type="text"  id="TPago" name="TPago" value="Pago">
      <div class="container-fluid">
        <div class="card card-default">
          <div class="card-header">
            <h3 class="card-title">Datos de Tipo Pago</h3>
          </div>
          <div class="card-body">
            <div class="row">
           <div class="col-md-6">
               <div class="form-group">
                  <center><label for="exampleInputEmail1" style="margin-left: -41px;font-size: 20px;">Codigo Tipo Pago</label></center>
              ...
              <div class="col-md-6">
                <div class="form-group">
                  <label for="exampleInputEmail1">Nombre Tipo Pago</label>
                 ...
                 <div class="col-md-4">
                      <br>
                     <center><button type="submit" form="mantenTPago" style="background-color:#3c3c3c" class="btn btn-block btn-success">Guardar</button></center> 
                  </div>
            </div>
          </div>
        </div> 
