...
<head>
  ...
  <title>Sistema Repuestos |Mantenimiento Tipo de Repuestos</title>
  ...
  <div class="content-wrapper">
   <section class="content-header">
      <div class="container-fluid">
        <div class="row mb-2">
          <div class="col-sm-6">
            <h1>Mantenimiento de Tipo de Repuesto</h1>
          </div>
          <div class="col-sm-6">
            <ol class="breadcrumb float-sm-right">
              ...
              <li class="breadcrumb-item" style="color:#0056b3;">Mantenimientos</li>
                <li class="breadcrumb-item" style="color:#3d3d3d"><b>Mantenimiento Tipo de Repuesto</b></li>
            </ol>
          </div>
        </div>
      </div>
        ...
        $consulta = "SELECT Id_Tiporepuesto as Id FROM tbl_tiporepuesto ORDER by Id_Tiporepuesto DESC LIMIT 1";
    ...
    <section class="content">
          <form action="Mantenimientos/Capas/Logica/Log.php" method="post" id="mantenTrep" name="mantenTrep">
             <input hidden type="text"  id="TRep" name="TRep" value="Repuesto">
      <div class="container-fluid">
        <div class="card card-default">
          <div class="card-header">
            <h3 class="card-title">Datos de Tipo de Repuestos</h3>
          </div>
          <div class="card-body">
            <div class="row">
           <div class="col-md-6">
                <div class="form-group">
                  <center><label for="exampleInputEmail1" style="margin-left: -41px;font-size: 20px;">Codigo Tipo Repuesto</label></center>
              ...
              <div class="col-md-6">
                <div class="form-group">
                  <label for="exampleInputEmail1">Nombre Tipo Repuesto</label>
                 ...
                 <div class="col-md-4">
                      <br>
                     <center><button type="submit" form="mantenTrep" style="background-color:#3c3c3c" class="btn btn-block btn-success">Guardar</button></center> 
                  </div>
            </div>
          </div>
        </div> 
