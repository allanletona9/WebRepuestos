...
<head>
  ...
  <title>Sistema Repuestos |Mantenimiento Clientes</title>
  ...
  <div class="content-wrapper">
    <section class="content-header">
          ...
          <div class="col-sm-6">
            <ol class="breadcrumb float-sm-right">
              ...
              <li class="breadcrumb-item" style="color:#0056b3;">Mantenimientos</li>
                <li class="breadcrumb-item" style="color:#3d3d3d"><b>Mantenimiento Clientes</b></li>
            </ol>
          </div>
        </div>
      </div>
      ...
      <?php
        ...
        $consulta = "SELECT Id_Cliente as Id FROM tbl_cliente ORDER by Id_Cliente DESC LIMIT 1";
    ...
    <section class="content">
        <form action="Mantenimientos/Capas/Logica/Log.php" method="post" id="mantenCliente" name="mantenCliente">
             <input hidden type="text"  id="Nombre" name="cliente" value="Cliente">
      <div class="container-fluid">
          ...
          <div class="card-body">
           ...
           <div class="col-md-6">
                <div class="form-group">
                  <center><label for="exampleInputEmail1" style="margin-left: -41px;font-size: 20px;">Codigo Cliente</label></center>
                  <center><input type="text" class="form-control" style="background-color:white;border: 0;width: 15%;font-size:25px;padding: .375rem 0rem;" 
                                 placeholder="<?php echo "0". $suma;?>" disabled></center> 
                </div>
              </div>
              <div class="col-md-6">
                <div class="form-group">
                ...
                <div class="col-md-4">
                 ...
                 <div class="col-md-4">
                      <br>
                     <center><button type="submit" form="mantenCliente" style="background-color:#3c3c3c" class="btn btn-block btn-success">Guardar</button></center> 
                  </div>
            </div>
          </div>
        </div> 
